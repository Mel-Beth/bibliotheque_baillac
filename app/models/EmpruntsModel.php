...
class EmpruntsModel {
    ...
    public function getEmpruntsByEmploye($prenomEmploye) {
        $query = "SELECT l.titre, ht.date_emprunt, ht.date_retour, e.isbn, emp.prenom AS employe_prenom, emp.nom AS employe_nom
                  ...
                  WHERE emp.prenom = :prenom AND (ht.date_retour IS NULL OR ht.date_retour >= CURRENT_DATE)";
    ...
    public function getAllEmprunts() {
        $query = "SELECT l.titre, ht.date_emprunt, ht.date_retour, e.isbn, emp.prenom AS employe_prenom, emp.nom AS employe_nom
                  ...
                  JOIN livres l ON e.isbn = l.isbn
                  JOIN employes emp ON ht.id_employe = emp.id_employe
                  WHERE ht.date_retour IS NULL OR ht.date_retour >= CURRENT_DATE";
    ...
    public function getRetours() {
        $query = "SELECT l.titre, ht.date_emprunt, ht.date_retour, e.isbn, emp.prenom AS employe_prenom, emp.nom AS employe_nom
                  ...
                  JOIN livres l ON e.isbn = l.isbn
                  JOIN employes emp ON ht.id_employe = emp.id_employe
                  WHERE ht.date_retour IS NOT NULL AND ht.date_retour >= CURRENT_DATE";
        return $this->db->query($query)->fetchAll(PDO::FETCH_ASSOC);
    }
    ...
    public function getRetards() {
        $query = "SELECT l.titre, ht.date_emprunt, ht.date_retour, e.isbn, emp.prenom AS employe_prenom, emp.nom AS employe_nom
                  ...
                  JOIN livres l ON e.isbn = l.isbn
                  JOIN employes emp ON ht.id_employe = emp.id_employe
                  WHERE ht.date_retour < CURRENT_DATE AND ht.date_retour IS NOT NULL";
        return $this->db->query($query)->fetchAll(PDO::FETCH_ASSOC);
    }
}
